...
function getApiConfig() {
    return {
        useApiServer: true,
        apiBaseUrl: process.env.API_URL || 'http://lctmr-backend-service:3001/api',
        frontendUrl: process.env.FRONTEND_URL || 'http://lctmr-frontend-service:80',
        backendUrl: process.env.BACKEND_URL || 'http://lctmr-backend-service:3001',
        isKubernetes: process.env.KUBERNETES_ENV === 'true' || !!process.env.KUBERNETES_SERVICE_HOST
    };
}
